  ...
  return (
    <>
      <main className="h-full">
        {/* <Navigation /> */}
        <section className="h-full w-full pt-[350px] relative flex items-center justify-center flex-col">
          {/* grid  */}
          <div
            aria-label="true"
          ...
          <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
            <h1 className="text-7xl font-bold text-center sm:text-[200px] ">
              WebCanvas
            </h1>
          </div>
        ...
        <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[-60px]">
          <h2 className="text-4xl text-center">Choose what fit you right</h2>
          <p className="text-muted-foreground text-center">
            Our straightforward pricing plans are tailored to meet you needs. If{" "}
            {"you're"} not
            <br />
